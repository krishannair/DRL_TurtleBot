...
def td3(n_games):
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            new_state, reward, done= env.step(act, past_action)
        ...
        if i % 25 == 0:
            agent.save_models()
        filename = 'Turtle_valid_td3_' + str(n_games) + '_games.png'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-eps', type=int, default=10, help='Number of training Episodes (default: 1000)')  
