...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('DDPG',
                                                'turtlebot3_simulations/turtlebot3_gazebo/models/turtlebot3_square/goal_box/model.sdf')
        self.modelPath = r"/home/krishan/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo/models/turtlebot3_square/goal_box/model.sdf"
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        while position_check:
                # goal_x_list = [0.6, -1.4, -0.5, 0.2, -0.8, -1, 1.2, 0.5, 1, 0.1, 0, -1.3, -0.7]
                # goal_y_list = [0, -1.3, -1.4, 1.5, -0.9, -1, 1.2, 1.5, 1.5, 1.4, -1, 0, -1.2]
                goal_x_list = [1, 1, -1, -1]
                goal_y_list = [1, -1, 1, -1]
        ...
        # if self.stage != 4:
        #     while position_check:
        #         goal_x = random.randrange(-3.4, 3.4) #/ 10.0
        #         goal_y = random.randrange(-3.4, 3.4) #/ 10.0
